//
//  ChartLimitRange.swift
//  Charts
//
//  Created by Greg Hart on 3/27/19.
//
...
open class ChartLimitRange: ComponentBase
{
    @objc(ChartRangeLabelPosition)
    ...
    @objc open var fillColor = NSUIColor(red: 237.0/255.0, green: 91.0/255.0, blue: 91.0/255.0, alpha: 0.1)
    ...
    @objc public init(start: Double, end: Double, label: String)
    {
        super.init()
        self.start = start
        self.end = end
